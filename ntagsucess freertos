...
Ntag ntag(Ntag::NTAG_I2C_1K,21,22);
...
//        Serial.println("Write block 2 failed");
//    } 
    Serial.println("here we have problem 1");
    if(!ntag.writeEeprom(16,eepromdata,6)){
        Serial.println("Write success");
    }
    Serial.println("here we have problem");
    Serial.println("\nReading memory block 1");
    if(ntag.readEeprom(0,readeeprom,16)){
        showBlockInHex(readeeprom,16);
    }
